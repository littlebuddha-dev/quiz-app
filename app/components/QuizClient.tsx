...
const CATEGORY_MAP: Record<Locale, Record<string, string>> = {
  ja: { '算数': '算数', '国語': '国語', '理科': '理科', '社会': '社会', '英語': '英語', '論理パズル': '論理パズル', 'プログラミング': 'プログラミング', '物理': '物理', '生物': '生物' },
  en: { '算数': 'Math', '国語': 'Language', '理科': 'Science', '社会': 'Social', '英語': 'English', '論理パズル': 'Logic', 'プログラミング': 'Coding', '物理': 'Physics', '生物': 'Biology' },
  zh: { '算数': '算术', '国語': '语文', '理科': '科学', '社会': '社会', '英語': '英语', '論理パズル': '逻辑', 'プログラミング': '编程', '物理': '物理', '生物': '生物' },
};
